import { getAgentInfo, type AgentInfo } from "~/api";

export async function loadContractData(token: string) {
  return MOCK_RESPONSE; // temp while I design some stuff

  // // get agent, contracts, and ships
  // const data = await getAgentInfo(token);

  // if (data.status === "error") {
  //   throw new Error(`Failed to fetch agent info: ${data.message}`);
  // }
...
const MOCK_RESPONSE: AgentInfo = {
  agent: {
    accountId: "cm9nfkkyk006xpt16vfh5xsb4",
    symbol: "JELLHEE",
    headquarters: "X1-HK16-A1",
    credits: BigInt(175000),
    startingFaction: "COSMIC",
    shipCount: 2,
  },
  contracts: [
    {
      id: "5e9f1b2c-8c3d-4a1e-9f1b-2c8c3d4a1e9f",
      ...
      accepted: false,
      fulfilled: false,
      expiration: new Date("2026-04-01T00:00:00.000Z"),
      deadlineToAccept: new Date("2026-03-25T00:00:00.000Z"),
    },
  ],
  ships: [
    {
      ...
      nav: {
        systemSymbol: "X1-HK16",
        waypointSymbol: "X1-HK16-A1",
        route: {
          destination: {
            symbol: "X1-HK16-A1",
            type: "PLANET",
          ...
          departureTime: new Date("2026-03-23T13:19:17.384Z"),
          arrival: new Date("2026-03-23T13:19:17.384Z"),
        },
        status: "DOCKED",
        flightMode: "CRUISE",
      },
      ...
      mounts: [
        ...
        },
        {
          ...
          name: "Gas Siphon II",
          description:
            "An advanced gas siphon that can extract gas and other resources from gas giants and other gas-rich bodies more efficiently and at a higher rate.",
          requirements: {
            power: 2,
            crew: 2,
          },
      ...
      fuel: {
        ...
        consumed: {
          amount: 0,
          timestamp: new Date("2026-03-23T13:19:17.384Z"),
        },
      },
      cooldown: {
        shipSymbol: "JELLHEE-1",
        totalSeconds: 0,
        remainingSeconds: 0,
      },
    },
    {
      ...
      nav: {
        ...
        route: {
          ...
          departureTime: new Date("2026-03-23T13:19:17.395Z"),
          arrival: new Date("2026-03-23T13:19:17.395Z"),
        },
        status: "DOCKED",
        flightMode: "CRUISE",
      },
      ...
      fuel: {
        ...
        consumed: {
          amount: 0,
          timestamp: new Date("2026-03-23T13:19:17.395Z"),
        },
      },
      cooldown: {
        shipSymbol: "JELLHEE-2",
        totalSeconds: 0,
        remainingSeconds: 0,
      },
    },
